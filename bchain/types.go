...
// MaxAddressLength bounds public address and raw public-key descriptors before parsing.
...
var (
	...
	// ErrAddressTooLong is returned before an oversized address reaches a decoder.
	ErrAddressTooLong = errors.New("Address exceeds the 256-byte limit")
...
// ValidateAddressLength rejects oversized address inputs before format decoding.
func ValidateAddressLength(address string) error {
...
type Tx struct {
	...
	// PIVX Shield
	VShieldIn    []VShieldIn  `json:"vShieldSpend,omitempty"`
	VShieldOut   []VShieldOut `json:"vShieldOutput,omitempty"`
