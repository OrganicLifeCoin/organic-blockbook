...
const (
	...
	// Staking Addresses
	STAKING_ADDR_MAIN = 95  // mainnet staking addresses start with 'f'
	STAKING_ADDR_TEST = 138 // testnet staking addresses start with 'x'
)
...
func init() {
	// OrganicLifeCoin mainnet address encoding
	MainNetParams = chaincfg.MainNetParams
	MainNetParams.Net = MainnetMagic
	MainNetParams.PubKeyHashAddrID = []byte{115} // starting with 'o'
	MainNetParams.ScriptHashAddrID = []byte{98}  // starting with 'g'
	MainNetParams.PrivateKeyID = []byte{45}      // WIF starts with 'K'

	// OrganicLifeCoin testnet address encoding (matches chainparams.cpp)
	TestNetParams = chaincfg.TestNet3Params
	TestNetParams.Net = TestnetMagic
	TestNetParams.PubKeyHashAddrID = []byte{127} // starting with 't'
	TestNetParams.ScriptHashAddrID = []byte{196} // starting with '2'
...
// GetChainParams contains network parameters for the configured OrganicLifeCoin network
